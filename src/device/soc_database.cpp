...
bool SoCDatabase::load() noexcept {
    ...
    db["SM8475"] = {"Snapdragon 8+ Gen 1", "Qualcomm", "ARMv9", "Cortex-X2/A710/A510", {}, 1,3,4, 3190000, 300000, 87, 1.2f, 550, false};

    // ────────── Snapdragon 8 Gen 1 / SM8450 ──────────
    db["SM8450"] = {"Snapdragon 8 Gen 1", "Qualcomm", "ARMv9", "Cortex-X2/A710/A510", {}, 1,3,4, 3000000, 300000, 82, 1.1f, 540, false};

    // ────────── Snapdragon 888 / SM8350 ──────────
    // 功耗优化: 火龙888，保守调频
    db["SM8350"] = {"Snapdragon 888", "Qualcomm", "ARMv8", "Cortex-X1/A78/A55", {}, 1,3,4, 2840000, 300000, 78, 0.65f, 380, false};

    // ────────── Snapdragon 865 / SM8250 ──────────
    // 功耗优化: 降低热限制，更保守的调频，更积极的小核迁移
    // 空闲时可下探到 300MHz 以降低静止功耗
    db["SM8250"] = {"Snapdragon 865", "Qualcomm", "ARMv8", "Cortex-A77/A55", {}, 1,3,4, 2840000, 300000, 82, 0.75f, 420, false};

    // ────────── Snapdragon 855 / SM8150 ──────────
    // 功耗优化: 降低热限制，更保守的调频
    db["SM8150"] = {"Snapdragon 855", "Qualcomm", "ARMv8", "Cortex-A76/A55", {}, 1,3,4, 2840000, 300000, 82, 0.70f, 400, false};

    // ────────── Snapdragon 7 Series ──────────
    db["SM7325"] = {"Snapdragon 778G / 782G", "Qualcomm", "ARMv8", "Cortex-A78/A55", {}, 1,3,4, 2400000, 200000, 87, 0.92f, 500, false};
    db["SM7450"] = {"Snapdragon 7+ Gen 2", "Qualcomm", "ARMv8", "Cortex-A710/A510", {}, 1,3,4, 2910000, 300000, 87, 1.15f, 540, false};
    db["SM7475"] = {"Snapdragon 7+ Gen 3", "Qualcomm", "ARMv9", "Cortex-A715/A510", {}, 1,3,4, 2800000, 300000, 87, 1.10f, 530, false};
    db["SM7635"] = {"Snapdragon 7s Gen 2", "Qualcomm", "ARMv8", "Cortex-A78/A55", {}, 0,4,4, 2400000, 200000, 88, 0.88f, 490, false};
    db["SM7675"] = {"Snapdragon 7 Gen 3", "Qualcomm", "ARMv9", "Cortex-A720/A520", {}, 1,3,4, 2630000, 300000, 87, 1.05f, 520, false};
