...
bool SysfsWriter::wc(int c, uint8_t pct) noexcept {
    ...
    if (access((cg_root_ + "/cgroup.subtree_control").c_str(), F_OK) == 0) {
        ...
        std::ofstream(p) << (1 + (pct * 9999 / 100));    } else {
